...
const { fetch, fetchById, create, update, deleteEmployee , fetchRankEmployee} = require("../controllers/EmployeeController.js");

const employee_route = express.Router();

employee_route.get("/fetch", fetch);
employee_route.get("/fetchById/:id", fetchById);
employee_route.get("/fetchRankEmployee/:start_date/:end_date", fetchRankEmployee)
